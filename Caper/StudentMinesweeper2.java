...
public class StudentMinesweeper2 extends JFrame { //extends JFrame обеспечивает возникновение окошка на экране. Extends наследования от класса JFrame.

    private JLabel label;

    Color mainColor = new Color(22, 53, 135, 255);
    final int FIELD_SIZE = 15; // Размер нашего поля т.е. 12 на 12. т.е. 12 на 12, квадратиков.
    ...
    final int NUMBER_OF_MINES = 40; //Кол-во мин, т.е. 40.
    ...
    public StudentMinesweeper2() {  // основная часть Сапёра.
                    ...
                    if (e.getButton() == MOUSE_BUTTON_LEFT) // Левая кнопка мыши отжата, и мина не взорволась и не было победы, то...
                        if (field[y][x].isNotOpen()) {  // Если это ячейка не открыта, то...
                            ...
                            if (youWon) {
                                ...
                                frame1.setBounds(370, 160, 900, 545);
                                frame1.setVisible(true);
                                frame1.setContentPane(new Win2Panel());
                            }
                            ...
                            if (bangMine) {  // Вторая проверка. Если взорвалась мина, то...
                                ...
                                frame.setBounds(380, 180, 900, 580);
                                frame.setVisible(true);
                                frame.setContentPane(new Troll2Panel());
                            }
                        }
    ...
    class Troll2Panel extends JPanel{
        public void paintComponent(Graphics g){
            Image im = null;
            try {
                im = ImageIO.read(new File("C:\\Troll2.jpg"));
            } catch (IOException e) {}
    ...
    class Win2Panel extends JPanel{
        public void paintComponent(Graphics g){
            Image im = null;
            try {
                im = ImageIO.read(new File("C:\\Win2.jpg"));
            } catch (IOException e) {}
            g.drawImage(im, 0, 0, null);
